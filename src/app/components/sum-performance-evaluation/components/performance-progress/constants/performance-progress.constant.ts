...
export const GET_PERFORMANCE_EVALUATION_PAGING = gql`
    query GetPerformanceEvaluationList(
        $cycleId: Int!
        $departmentId: Int!
        $name: String
        $pageNo: Int
...
export const GET_PERFORMANCE_EVALUATION_TITLE = gql`
query GetPerformanceEvaluationTitle($cycleId: Int!) {
