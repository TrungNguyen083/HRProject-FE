...
import { IEmployee, IEmployeeParams } from '../models/employee-management.model';

export const setLoading = createAction('[Employee] Set Loading', props<{ loading: boolean }>());
export const setEmployees = createAction('[Employee] Set Employees', props<{ employees: PaginatedData<IEmployee> }>());
export const setEmployee = createAction('[Employee] Set Employee', props<{ employee: IEmployee }>());
export const setNewEmployees = createAction('[Employee] Set New Employees', props<{ newEmployees: IEmployee[] }>());
